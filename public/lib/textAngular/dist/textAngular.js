	...
	function($compile, textAngularManager, taOptions, taTools, taToolExecuteAction, $window){
		return {
			...
			link: function(scope, element, attrs){
				...
				element[0].innerHTML = '';
				element.addClass('layout="row" layout-align="start start"' + scope.classes.toolbar);
				...
				var setupToolElement = function(toolDefinition, toolScope){
					...
					else toolElement = angular.element("<md-button style='padding: 0 10px 0 0; min-width:20px' type='button'>");
