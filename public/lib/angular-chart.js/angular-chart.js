(function (factory) {
  ...
  if (typeof exports === 'object') {
    ...
    define(['angular', 'Chart.min.js'], factory);
  } else {
    // Browser globals
  ...
  /**
   * Wrapper for Chart.min.js.js
   * Allows configuring Chart.min.js js using the provider
   *
   * angular.module('myModule', ['Chart.min.js.js']).models(function(ChartJsProvider) {
  ...
  function ChartJsProvider () {
    ...
    this.setOptions = function (type, customOptions) {
      ...
      // Set options for the specific Chart.min.js
  ...
  function ChartJsFactory (ChartJs, $timeout) {
    return function chart (type) {
      return {
        ...
        link: function (scope, elem/*, attrs */) {
          ...
          container.className = 'Chart.min.js-container';
          ...
          function resetChart (newVal, oldVal) {
            ...
            // Chart.min.js.update() doesn't work for series and labels
            // so we have to re-create the Chart.min.js entirely
            if (chart) chart.destroy();
            ...
            if (typeof console !== 'undefined' && ChartJs.getOptions().env !== 'test') {
              ...
              if (!! scope[attr]) {
                warn.call(console, '"%s" is deprecated and will be removed in a future version. ' +
                  'Please use "Chart.min.js-%s" instead.', attr, attr);
              }
            }
          }
        }
    ...
    function setLegend (elem, chart) {
      var $parent = elem.parent(),
          $oldLegend = $parent.find('Chart.min.js-legend'),
          legend = '<Chart.min.js-legend>' + chart.generateLegend() + '</Chart.min.js-legend>';
