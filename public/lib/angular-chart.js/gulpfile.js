(function () {
  ...
  gulp.task('cover', shell.task([
    './node_modules/istanbul/lib/cli.js instrument angular-Chart.min.js.js > test/fixtures/coverage.js'
  ]));
  ...
  gulp.task('bower', function () {
    return gulp.src('./angular-Chart.min.js.js')
  ...
  gulp.task('build', function () {
    return gulp.src(['dist/*', '!./dist/*.tar.gz'])
      .pipe(tar('angular-Chart.min.js.js.tar'))
