...
### cdn
    ...
    //cdn.jsdelivr.net/angular.chartjs/latest/angular-chart
...
<body>
  ...
  <script src="bower_components/Chart.js/chart"></script>
  <script src="bower_components/angular-chart.js/dist/angular-chart"></script>
```
