...
Guidlines:
 ...
 - Please make changes to the files in [`/src`](https://github.com/nnnick/Chart.js/tree/master/src), not `Chart.js` or `chart` in the repo root directory, this avoids merge conflicts
